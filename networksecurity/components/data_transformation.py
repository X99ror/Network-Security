...
class DataTranformation:
    ...
    def get_data_transformer_object(cls)->Pipeline:
        """Initiating the KNNImputer"""
        try:
            imputer:KNNImputer=KNNImputer(**DATA_TRANSFORMATION_IMPUTER_PARAMS)
            logging.info(f"Initialisng KNNImputer with these params {DATA_TRANSFORMATION_IMPUTER_PARAMS}")
    ...
    def initiate_dat_transformation(self)->DataTransformationArtifact:
        ...
        try:
            ...
            ## or we can directly use fit_transform for train
